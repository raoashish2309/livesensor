...
class ModelEvaluation:
    ...
    def __init__(self,model_eval_config:ModelEvaluationConfig,
                 ...
                 model_training_artifact:ModelTrainingArtifact) -> None:
        try:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            y_true = y_true.replace(TargetValueMapping().to_dct()).infer_objects(copy=False)
            df.drop(TARGET_COLUMN,axis=1,inplace=True)

            train_model_file_path = self.model_training_artifact.trained_model_file_path
            ...
            # Save the report
            evaluation_report_dir = os.path.dirname(self.model_eval_config.report_file_path)
